...
class EncoderDecoder(AttModel):  
    def __init__(self, args, tokenizer):  
        ...
        self.lstm = nn.LSTM(input_size=args.d_model, hidden_size=args.d_model, num_layers=1, batch_first=True)
    ...
    def _forward(self,  att_feats, seq):  # batch[8, 98, 2048] target[16, 60]
        ...
        if self.args.mode == "CNN-TD":
            out = self.model.decode(seq, att_feats, att_masks, seq_mask)  # [2, 44, 512]
